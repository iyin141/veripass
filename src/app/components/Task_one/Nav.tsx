...
const Nav = () => {
  ...
  return (
      ...
      <div className='pt-5 lg:pl-[5%] pr-[5%] flex pb-3 justify-between  '>
              <div className={`${show ? 'flex flex-col justify-center w-[100%] bg-white text-center gap-12 pt-5 absolute lg:hidden pb-5 mt-12 ' : 'hidden'}`}>
              ...
              <Link href='/'><Image src={logo} className='w-[9.5rem] lg:w-[7.5rem] h-[1.5rem] max-lg:pl-[5%]' alt='' /></Link>
