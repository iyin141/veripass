...
import hero from '../../../../public/img/hero_2.png'
...
const Hero = () => {
  return (
      <div >
          <div className='flex justify-between max-lg:flex-col lg:pl-[6%] pb-[20vh] max-xl:pb-[5vh] pt-[3%]'>
              <div className='w-[45%] max-lg:w-[100%] max-lg:text-center flex flex-col gap-5  pt-[3%] max-lg:pl-[5%] max-lg:pr-[5%] max-sm:text-left'>
        ...
        <div className='w-[50%] max-lg:w-[100%]'>
          <Image src={hero} className='w-[100%] xl:h-[100vh] max-xl:h-[100%]' alt=''/>
        </div>
